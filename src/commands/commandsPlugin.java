    ...
    public void registerClientCommands(CommandHandler handler){
        ...
        */
        ...
        handler.<Player>register("mcv", "Vote to clear map", (args, player) -> {
            ...
            Groups.unit.each(u -> u.kill());
        	Groups.build.each(b -> if(block != null && (block.block != Blocks.coreShard && block.block != Blocks.coreNucleus && block.block != Blocks.coreFoundation && block.block != Blocks.coreBastion && block.block != Blocks.coreAcropolis && block.block != Blocks.coreCitadel && block.block != Blocks.worldProcessor && block.block != Blocks.worldCell && block.block != Blocks.worldMessage) {
                b.kill()
            });
